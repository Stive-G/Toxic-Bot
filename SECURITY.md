...
If you operate a self-hosted ToxicBot instance and suffer a security incident:
...
- If you need upstream help, file a private security advisory and include sanitized reproduction steps and the ToxicBot version/commit.
...
## Privacy & Telemetry
- ToxicBot does not phone home or collect usage data by default. (If you plan to add telemetry, it must be opt-in, documented, and transparent.)
...
Thank you for helping keep ToxicBot safe.
