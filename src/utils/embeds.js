...
const EMBED_FOOTER_SYMBOL = Symbol('toxicbotFooterText');
const EMBED_BASE_DESCRIPTION_SYMBOL = Symbol('toxicbotBaseDescription');
...
function isImportantFooter(footerText) {
  ...
  return /\b(close|closes|closed|expire|expires|available in|page\s+\d+|dashboard closes|ticket id|toxic bot)\b/.test(normalized);
}
